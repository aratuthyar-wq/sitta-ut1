/**
 * script.js — Shared JavaScript Utilities SITTA
 * Universitas Terbuka
 * Folder: js/script.js
 *
 * Berisi fungsi-fungsi yang dipakai bersama di semua halaman:
 * - Cek sesi login
 * - Helper modal
...
/* ── CEK SESI (panggil di setiap halaman kecuali login) ── */
function cekSesi() {
  ...
  /* Isi UI topbar jika ada elemennya */
